...
# budget. session_start specifically must fail open (return {}) with no cognee creds.
...
cd "$PLUGIN"
fire_hook session_start.py      '{"hook_event_name":"SessionStart","cwd":"'"$PLUGIN"'","source":"startup"}' '^{}$'
